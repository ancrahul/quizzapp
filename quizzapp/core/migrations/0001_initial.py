...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img_question', models.ImageField(blank=True, null=True, upload_to='questions')),
        ...
        migrations.AddField(
            model_name='quizzlog',
            name='user',
            field=models.ManyToManyField(through='core.UserQuizzScore', to=settings.AUTH_USER_MODEL),
        ),
    ]
